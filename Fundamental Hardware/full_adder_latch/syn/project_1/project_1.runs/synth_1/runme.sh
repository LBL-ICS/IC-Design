...
HD_PWD='C:/Mirror/Teaching/CENG5534/ADSD_SP2024/projects/full_adder_latch/syn/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_latch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_latch.tcl
