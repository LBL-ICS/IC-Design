...
HD_PWD='C:/Mirror/Teaching/CENG5534/ADSD_SP2024/projects/full_adder_tri/syn/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_tri.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source full_adder_tri.tcl -notrace
